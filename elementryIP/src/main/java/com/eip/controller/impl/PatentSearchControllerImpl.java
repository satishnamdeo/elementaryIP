...
public class PatentSearchControllerImpl implements PatentSearchController{
	...
	@RequestMapping(value="{searchQueryStr}/viewPatent" , method = { RequestMethod.POST,RequestMethod.GET })
	public String viewPatent(@PathVariable("searchQueryStr") String searchQueryStr,ModelMap map){
		JSONObject patent=new JSONObject();
		JSONArray properties=new JSONArray();
		if(searchQueryStr!=null && !searchQueryStr.equals("")){
			patent=patentSearchService.viewPatent(searchQueryStr);
